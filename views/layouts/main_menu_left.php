    ...
    <section class="sidebar">
        ...
        <div class="user-panel">
            ...
            <div class="pull-left info">
                <p><?= \Yii::$app->user->identity->characterName; ?></p>
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="<?= Url::to(['/market/schedule/index']); ?>"><i class="fa fa-circle-o"></i> <span>Schedule</span></a></li>
            ...
            <li><a href="<?= Url::to(['/manufacture/index/index']); ?>"><i class="fa fa-circle-o"></i> <span>Search item</span></a></li>
