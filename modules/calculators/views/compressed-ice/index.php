                    ...
                    <?php foreach ($group->getCompressedIce() as $invType): ?>
                        ...
                        <div class="panel box box-primary">
                            <div class="box-header with-border">
                                <div class="row">
                                    <div class="col-md-8">
                                        <a data-toggle="collapse" data-parent="#accordion" href="#collapse<?= $item->typeID; ?>" aria-expanded="false" class="collapsed" style="padding: 0; margin: 0;">
                            ...
                            <div id="collapse<?= $item->typeID; ?>" class="panel-collapse collapse" aria-expanded="false" style="height: 0;">
                                <div class="box-body">
